...
# # Insert image
image_path = "Snail.png"
masks = color_mask_generator(image_path)

xy_up = position_list()
uv_exposure = 0.3 # in seconds
inks = ('SKIP', 'Cy3', 'Tye665', 'Atto488', 'Tex615', '1M CaCl2') #List of chemicals in each valve

for ink in range(1, 6):
    #print('Starting %s flow for 5 seconds' % inks[ink])
    if ink == 1 or ink == 2 or ink == 3 or ink == 4:
        print('Starting %s flow for 60 seconds' % inks[ink])
        valve_timer(valves[ink], 60)  # Open valve for ink 1, 2, or 3 for 90 seconds
        ...
        valve_timer(valves[5], 90)  # Open valve for 1X TAEM for 90 seconds

    # elif ink == 4:
    #     continue  # Skip 1X TAEM
        
    # elif ink == 5:
    #     print('Flowing %s for 60 seconds'% inks[5])
    #     valve_timer(valves[5], 60)  # Open valve for 1M NaCl for 60 seconds
    #     time.sleep(1)
        
print('Multidomain patterning completed.')
...
#%% Timer for sacrificial layer removal in 1 hour

# print("\nStarting to dissolve sacrificial layer... \nPlease wait...")

# remaining_time = 3600 # 1 hour (3600 seconds)

# while remaining_time > 0:
#     if remaining_time > 600:  # More than 10 minutes remaining
#         print(f"Remaining time: {int(remaining_time / 60)} minutes")
#         time.sleep(600)  # Sleep for 10 minutes (600 seconds)
#     elif remaining_time <= 600 and remaining_time > 300:  # Between 10 and 5 minutes remaining
#         print(f"Remaining time: {int(remaining_time / 60)} minutes")
#         time.sleep(60)  # Sleep for 1 minute (60 seconds)
#     else:  # Less than or equal to 5 minutes remaining
#         if remaining_time % 60 == 0:  # Display every minute
#             print(f"Remaining time: {int(remaining_time / 60)} minutes")
#         time.sleep(1)  # Sleep for 1 second
#     remaining_time -= 60 if remaining_time > 300 else 1

# print("Sacrificial layer dissolved. \nPLEASE REMOVE MICROFLUIDIC DEVICE")
